...
function popupOpened(popup) {
  ...
  function openbigImg(element) {
    const photoimg = element.querySelector(".photo-grid__img");
    photoimg.addEventListener("click", function () {
        popupOpened(popupbigImg);
      const photoTitle = element.querySelector(".photo-grid__title").textContent;
      bigImg.src = photoimg.src;
      bigImg.alt = photoimg.alt;
      popupbigImgCap.textContent = photoTitle;
    });
  }
  ...
  function initCard(image, title) {
    const photoElement = photoTemplate
      ...
      .cloneNode(true);
      photoElement.querySelector(".photo-grid__img").src = image;
